...
const HomePage = () => {
  ...
  return (
    <div className="  scroll-smooth p-20 bg-white">
      ...
      <div className="flex mt-[15%] justify-between">
        ...
        <div className=" w-[40%]  mt-5">
          <h1 className=" font-extrabold text-3xl text-center">track your Code<span className="text-orange-500">Forces</span> journey With Me</h1>
        </div>
      ...
      <div className=" mx-auto w-[70%] mt-20">
        ...
        <h2  className="text-gray-500 text-3xl mt-6 font-semibold " >Streamlined in CodeTracker to simplify your
          coding journey</h2>
      </div>
